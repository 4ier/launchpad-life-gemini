...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    pattern: [
      ...
      {x:4,y:4},{x:6,y:4},{x:8,y:4},{x:10,y:4},{x:12,y:4},
      {x:3,y:5},{x:5,y:5},{x:7,y:5},{x:9,y:5},{x:11,y:5},
      {x:4,y:6},{x:6,y:6},{x:8,y:6},{x:10,y:6},{x:12,y:6},
      {x:3,y:7},{x:5,y:7},{x:7,y:7},{x:9,y:7},{x:11,y:7},
      {x:4,y:8},{x:6,y:8},{x:8,y:8},{x:10,y:8},{x:12,y:8},
      {x:3,y:9},{x:5,y:9},{x:7,y:9},{x:9,y:9},{x:11,y:9},
      {x:4,y:10},{x:6,y:10},{x:8,y:10},{x:10,y:10},{x:12,y:10},
      {x:3,y:11},{x:5,y:11},{x:7,y:11},{x:9,y:11},{x:11,y:11},
    ]
  },
  {
    name: "Arrowhead",
  ...
  },
  {
    ...
    pattern: [
      ...
      {x:12,y:2},{x:13,y:2},{x:12,y:3},{x:13,y:3},
      {x:2,y:12},{x:3,y:12},{x:2,y:13},{x:3,y:13},
